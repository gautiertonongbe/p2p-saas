        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Dialog open={uploadDialogOpen} onOpenChange={setUploadDialogOpen}>
            <DialogTrigger asChild>
              <Button className={`w-full sm:w-auto btn-primary ${!canManage ? "hidden" : ""}`}>
                  ...
                  >
                    ...
                    <TableCell className="text-right">
                      <ActionMenu actions={[
                        ...
                        { icon: <Edit2 className="h-4 w-4" />, label: "Modifier", href: `/invoices/${invoice.id}`, hidden: !["draft","pending_approval"].includes(invoice.status) || !canManage },
